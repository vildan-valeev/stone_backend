 ...
 */
 import {mxClient, mxUtils, mxEventSource, mxPopupMenu, mxGraphView, mxGraph, mxGraphHandler, mxConnectionHandler, mxPopupMenuHandler, mxResources, mxConstants, mxText, mxGraphModel, mxSvgCanvas2D, mxShape, mxRectangle, mxPoint, mxCellHighlight, mxImage, mxStackLayout, mxCellRenderer, mxConnector, mxStencil, mxStencilRegistry, mxObjectCodec , mxCodecRegistry, mxUndoManager, mxEvent, mxLayoutManager, mxCell, mxGeometry } from '../jGraphLib/mxClient'
 import Editor from '../js/Editor'
 import {Graph, HoverIcons} from '../js/Graph.js'
...
Sidebar.prototype.createDragSource = function(elt, dropHandler, preview, cells, bounds)
{
	...
	var arrowUp = createArrow(HoverIcons.prototype.triangleUp, mxResources.get('connect'));
	var arrowRight = createArrow(HoverIcons.prototype.triangleRight, mxResources.get('connect'));
	var arrowDown = createArrow(HoverIcons.prototype.triangleDown, mxResources.get('connect'));
	var arrowLeft = createArrow(HoverIcons.prototype.triangleLeft, mxResources.get('connect'));
	var styleTarget = createArrow(HoverIcons.prototype.refreshTarget, mxResources.get('replace'));
	// Workaround for actual parentNode not being updated in old IE
	var styleTargetParent = null;
	var roundSource = createArrow(HoverIcons.prototype.roundDrop);
	var roundTarget = createArrow(HoverIcons.prototype.roundDrop);
